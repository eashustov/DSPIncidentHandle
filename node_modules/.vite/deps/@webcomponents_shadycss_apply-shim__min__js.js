...
var require_apply_shim_min = __commonJS({
  "node_modules/@webcomponents/shadycss/apply-shim.min.js"(exports) {
    (function() {
      "use strict";
      var k = !(window.ShadyDOM && window.ShadyDOM.inUse), p;
      function r(a) {
        p = a && a.shimcssproperties ? false : k || !(navigator.userAgent.match(/AppleWebKit\/601|Edge\/15/) || !window.CSS || !CSS.supports || !CSS.supports("box-shadow", "0 0 0 var(--foo)"));
      }
      var t;
      ...
      function w(a) {
        var b = a = a.replace(ba, "").replace(ca, ""), c = new v();
        c.start = 0;
        c.end = b.length;
      ...
      function D(a, b, c) {
        ...
        if (a.cssText || a.rules) {
          ...
          if (f) {
            ...
            b ? b = a.cssText : (b = a.cssText, b = b.replace(fa, "").replace(ha, ""), b = b.replace(ia, "").replace(ja, "")), (d = b.trim()) && (d = "  " + d + "\n");
        }
        d && (a.selector && (c += a.selector + " {\n"), c += d, a.selector && (c += "}\n\n"));
        return c;
      }
      var C = 1, A = 7, z = 4, B = 1e3, ba = /\/\*[^*]*\*+([^/*][^*]*\*+)*\//gim, ca = /@import[^;]*;/gim, fa = /(?:^[^;\-\s}]+)?--[^;{}]*?:[^{};]*?(?:[;\n]|$)/gim, ha = /(?:^[^;\-\s}]+)?--[^;{}]*?:[^{};]*?{[^}]*?}(?:[;\n]|$)?/gim, ia = /@apply\s*\(?[^);]*\)?\s*(?:[;\n]|$)?/gim, ja = /[^;:]*?:[^;]*?var\([^;]*\)(?:[;\n]|$)?/gim, ea = /^@[^\s]*keyframes/, y = /\s+/g;
      var E = /(?:^|[;\s{]\s*)(--[\w-]*?)\s*:\s*(?:((?:'(?:\\'|.)*?'|"(?:\\"|.)*?"|\([^)]*?\)|[^};{])+)|\{([^}]*)\}(?:(?=[;\s}])|$))/gi, H = /(?:^|\W+)@apply\s*\(?([^);\n]*)\)?/gi, ka = /@media\s(.*)/;
      ...
      R.prototype.v = function(a, b) {
        ...
        return (a = a._gatheredStyle) ? this.s(a, b) : null;
      };
          ...
          if (d = b[g]) {
            if (h = d.split(":"), 1 < h.length) {
              ...
              if (c) {
                ...
                h = d;
                var n = ma.exec(e);
                n && (n[1] ? (l.h || (l.h = document.createElement("meta"), l.h.setAttribute("apply-shim-measure", ""), l.h.style.all = "initial", document.head.appendChild(l.h)), h = window.getComputedStyle(l.h).getPropertyValue(h)) : h = "apply-shim-inherit", e = h);
              }
              f[d] = e;
            }
          }
      ...
      function oa(a, b, c, d, e, f) {
        d && M(d, function(wa, F) {
          F && a.g.get(F) && (e = "@apply " + F + ";");
        });
        if (!e)
          return b;
        var g = S(a, "" + e, f);
        f = b.slice(0, b.indexOf("--"));
        var h = g = T(a, g, true), l = a.g.get(c), n = l && l.m;
        n ? h = Object.assign(Object.create(n), g) : a.g.set(c, h);
        var m = [], q, Z = false;
        for (q in h) {
          var G = g[q];
          void 0 === G && (G = "initial");
      ...
      R.prototype.detectMixin = R.prototype.A;
      R.prototype.transformStyle = R.prototype.s;
      R.prototype.transformCustomStyle = R.prototype.j;
      R.prototype.transformRules = R.prototype.u;
      R.prototype.transformRule = R.prototype.l;
      R.prototype.transformTemplate = R.prototype.v;
      R.prototype._separator = "_-_";
      Object.defineProperty(R.prototype, "invalidCallback", { get: function() {
        return Q;
      }, set: function(a) {
        Q = a;
      } });
      ...
      function ua(a) {
        ...
        a._validating || (a._validating = true, ra.then(function() {
      ...
      function X(a) {
        !a.g && window.ShadyCSS.CustomStyleInterface && (a.g = window.ShadyCSS.CustomStyleInterface, a.g.transformCallback = function(b) {
          V.j(b);
      ...
      W.prototype.prepareTemplate = function(a, b) {
        X(this);
        "" === N(a) && (U[b] = a, b = V.v(a, b), a._styleAst = b);
      };
      ...
      W.prototype.styleSubtree = function(a, b) {
        ...
        if (a.shadowRoot)
          for (this.styleElement(a), a = a.shadowRoot.children || a.shadowRoot.childNodes, b = 0; b < a.length; b++)
      ...
      if (!window.ShadyCSS || !window.ShadyCSS.ScopingShim) {
        ...
        window.ShadyCSS = { prepareTemplate: function(a, b) {
          Y.flushCustomStyles();
          ...
          Y.flushCustomStyles();
        }, nativeCss: u, nativeShadow: k, cssBuild: t, disableRuntime: aa };
...
export default require_apply_shim_min();
//# sourceMappingURL=@webcomponents_shadycss_apply-shim__min__js.js.map
