...
@Repository
@Profile("prod")
public interface DSPIncidentAffectedCountRepoProd extends DSPIncidentAffectedCountRepo{
    ...
    @Query(value = "select \n" +
            ...
            "  group by HPC_AFFECTED_ITEM_NAME order by \"Affected_Item\" asc", nativeQuery = true)
